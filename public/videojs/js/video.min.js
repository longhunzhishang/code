		...
		86: [function(a, b, c) {
			...
			var e = a(95),
				...
				j = c.logByType = function(a, b) {
					...
					// console.log("======86dd========",d,(f["default"].console, b));
					// console.log("======86  dd['code']========",d['code'],Array.isArray(a),(0, h.isObject)(a),String(a),JSON.stringify(a));
					if(d.apply)
					{
						window.videojsError && window.videojsError();
						return ;
					}
