...
function Resizer(conf){
    ...
    function caluateItem(tempItem){
        ...
        var maxHeight = 0, totalHeight = 0, totalWidth = 0;
        ...
        var leftWidth = avaibleWidth - newWidthTotal;
        ...
        var totalHeightI = 0, isSameHeight = true, tempHeight;
        ...
        $.each(tempItem, function(index, val) {
            var item = tempItem[index];
            // item.elementCss.marginRight = item.elementCss.marginRight + apc;
        })
