...
<style type="text/css">
  ...
  <div>
    <H2>欢迎来到 最新 平台 广告 测试页面 （已测试）</H2>

	<p>功能 说明 ：获取 平台广告 信息</p>
   
    <p>请求方式：<small>get</small></p>
   
    <p>请求参数说明：<small>sort 排序 默认 desc; <br/>
    size 显示数据个数 默认10 条数据 
    <br/>
    platform 1 pc 2 移动端 0 所有平台
    </small></p>
    ...
    <table  class="apitable" >
    	...
    	<tr >
    		<td >getRecentMobileAds</td>
    		<td >获取移动广告信息</td>
    		<td >http://localhost/api/v1/recent/ads/mobile</td>
     ...
     <p style="margin-top:10px;">测试 getRecentMobileAds</p>
    <form action="{{url('test/recent/ads/mobile')}}" method="get">
        <table>
