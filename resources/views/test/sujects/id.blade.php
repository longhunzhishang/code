...
<style type="text/css">
  ...
  <div>
    <H2>欢迎来到 subject getInfoById 测试页面(已测试)</H2>

    <p>功能 说明 ： 
    <small>根据 id 获取 subject 信息</small>
    </p>
   
    <p>请求方式：<small>get</small></p>

    <p>请求地址：<small>http://localhost/api/v1/subject/id</small></p>
    ...
    <table  class="apitable" >
        ...
        <tr >
            <td >getInfoById </td>
            <td >获取subject 信息</td>
            <td >http://localhost/api/v1/subject/id</td>
            <td >id</td>
     ...
     <p style="margin-top:10px;">测试 getInfoById </p>
    <form action="{{url('subject/test/id')}}" method="get">
