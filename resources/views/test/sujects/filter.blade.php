...
<style type="text/css">
  ...
  <div>
    <H2>欢迎来到 subjects getInfoByFilter 测试页面(已测试)</H2>

    <p>功能 说明 ： 
    <small>根据 host 获取 subjects 信息 返回 特定 字段 ['host','cname','ename']</small>
    </p>
   
    <p>请求方式：<small>get</small></p>

    <p>请求地址：<small>http://localhost/api/v1/subject/filter</small></p>
    ...
    <table  class="apitable" >
        ...
        <tr >
            <td >getInfoByFilter </td>
            <td >获取所有 subject 信息</td>
            <td >http://localhost/api/v1/subject/filter</td>
            <td >host</td>
     ...
     <p style="margin-top:10px;">测试 getInfoByFilter </p>
    <form action="{{url('subject/test/filter')}}" method="get">
