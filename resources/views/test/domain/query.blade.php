...
<style type="text/css">
  ...
  <div>
    <H2>欢迎来到 domain getQueryInfoByField 测试页面(已测试)</H2>

    <p>功能 说明 ： 
    <small>根据 首页 搜素内容 查询 返回 数据</small>
    </p>
   
    <p>请求方式：<small>get</small></p>

    <p>请求地址：<small>http://localhost/api/v1/domain/query/field</small></p>
   
    <p>请求参数说明：<small> host 收索内容;orderBy : 根据 字段进行排序;size 显示条数 默认 10 条</small></p>
    ...
    <table  class="apitable" >
        ...
        <tr >
            <td >getQueryInfoByField </td>
            <td >获取所有 domain 信息</td>
            <td >http://localhost/api/v1/domain/query/field</td>
            <td >host,orderBy , size</td>
            <td > data,total,status</td>
        </tr>

    </table>

     <p style="margin-top:10px;">测试 getQueryInfoByField </p>
    <form action="{{url('domain/test/query/field')}}" method="get">
