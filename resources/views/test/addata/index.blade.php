...
<style type="text/css">
  ...
  <div>
    <H2>欢迎来到addata getAllById 测试页面</H2>

    <p>功能说明 ：根据 编号 获取 addata 信息</p>
   
    <p>请求方式：<small>get</small></p>
   
    <p>请求参数说明：<small style="display:block">sort 排序 默认 desc;<br/> size 显示数据个数 默认10 条数据 </small></p>
    ...
    <table  class="apitable" >
        ...
        <tr >
            ...
            <td >http://localhost/api/v1/addata/find/id</td>
    ...
    <form action="{{url('addata/test/find/id')}}" method="get">
        <table>
