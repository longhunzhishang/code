...
<style type="text/css">
  ...
  <div>
    <H2>欢迎来到 getAllFilterSearch 测试页面(已测试)</H2>

    <p>功能 说明 ：
    <small>
          主页 收索  过滤 条件 获取 ads 数据
    </small>
    </p>
   
    <p>请求方式：<small>get</small></p>

    <p>请求地址：<small>http://localhost/api/v1/addata/filter/search</small></p>
    ...
    <p>
    返回结果说明：<small>data 数据; status 状态码;total 总条数;last_id 当前最大 编号;
    <br/>{"status":200,"data":[],"total":"xxx","last_id":"xxx"}
    ...
    <table  class="apitable" >
        ...
        <tr >
            <td >getAllFilterSearch </td>
            <td >获取 addata 信息</td>
            <td >http://localhost/api/v1/addata/filter/search</td>
            <td >ids</td>
            <td > data 数据 status 状态吗</td>
            <td>http://localhost/addata/test/search</td>
        </tr>

    </table>

    <p style="margin-top:10px;">测试 getAllFilterSearch </p>
    <form action="{{url('addata/test/search')}}" method="get">
        
        <table class="table_test">
            
            <tr >
                <td colspan="2"> wd <input type="text" name="wd"></td>
